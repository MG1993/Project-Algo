...
class User:
    ...
    @classmethod #saves the  new  user
    ...
    @classmethod #find user by email for sign in
    ...
    @classmethod #finds users by their id to validate them
    ...
    @staticmethod #validates that the user has registered properly
    ...
    @staticmethod #validates that the user logs in properly
